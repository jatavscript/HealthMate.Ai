...
const AdminLogin: React.FC = () => {
  const [email, setEmail] = useState('admin@healthmate.ai');
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to HealthMate.AI Administration</p>
          </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div className="text-xs text-blue-700 space-y-1">
              <p><strong>Email:</strong> admin@healthmate.ai</p>
              <p><strong>Password:</strong> admin123</p>
              <p className="mt-2 text-blue-600">Use these credentials to access the admin dashboard.</p>
            </div>
          </div>
        </div>
      </div>
